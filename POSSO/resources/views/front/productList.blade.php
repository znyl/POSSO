            ...
            <div class="main-gallery main-model roomy-80">
				...
				<div class="col-md-3 col-xs-6">
					<div class="product-container">
						...
						<p class="product-price @if($value['status_diskon']) line-through @endif">Rp. {{number_format($value['harga_product'])}} @if($value['status_diskon']) <span class="badge">{{$value['diskon']['discount']}}% Off</span></p> @endif
						<p class="product-price">@if($value['status_diskon']) { Rp. {number_format($value['diskon']['harga_diskon'])}} @endif</p>
					</div>
				</div>
				</a>
				@endforeach

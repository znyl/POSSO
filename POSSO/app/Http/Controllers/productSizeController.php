...
class productSizeController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if($insert->save())
        {
            return redirect()->action('productController@detailed',$request->id)->with('success','Ukuran berhasil ditambahkan');
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        if($insert->save())
        {
            return redirect()->action('productController@detailed',$request->id)->with('success','Ukuran berhasil diubah');
        }
    }
}

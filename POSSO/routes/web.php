...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('/admin/contactUs/detailed/{id}','contactUsController@detailed');
	...
	Route::get('/admin/setting/slider/index','sliderController@index');
	Route::get('/admin/setting/slider/activate/{id}','sliderController@activate');
	Route::get('/admin/setting/slider/unActivate/{id}','sliderController@unActivate');
	Route::post('/admin/setting/slider/insert','sliderController@insert');
	Route::get('/admin/setting/slider/delete/{id}','sliderController@delete');

	Route::get('/admin/setting/user/index','settingUserController@index');
	Route::post('/admin/setting/user/updatePassword','settingUserController@updatePassword');

	Route::get('/admin/data/export/excell/category','exportDataController@category');
});
//Routing for admin ends
